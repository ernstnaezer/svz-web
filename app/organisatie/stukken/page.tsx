...
export default function Page() {
  return (
    <ContentLayout title='Stukken'>
      <article className='prose lg:prose-lg'>
        <h3>Stukken</h3>
        <p>
          Op deze pagina kun je belangrijke documenten van de vereniging
          downloaden, waaronder onze notariële akte en het huishoudelijk
          reglement. Deze stukken geven je inzicht in de structuur en regels van
          onze vereniging. Klik op de onderstaande links om de documenten te
          bekijken.
        </p>
        <p>
          <ul>
            <li>
              <Link
                href='/downloads/Afschrift Akte SSV Zoetermeer 2021.pdf'
                download='Afschrift Akte SSV Zoetermeer 2021'
              >
            ...
            <li>
              <Link
                href='/downloads/Veiligheidsreglement SSV Zoetermeer 2017.pdf'
                download='Veiligheidsreglement SSV Zoetermeer 2017'
              >
                <div className='flex items-center gap-2 underline'>
                  Veiligheids Reglement{icon}
                </div>
              </Link>
            </li>
            <li>
              <Link
                href='/downloads/Informatiebrochure Privacy Gegevensbescherming KNSA.pdf'
                download='Informatiebrochure Privacy Gegevensbescherming KNSA'
              >
                <div className='flex items-center gap-2 underline'>
                  Informatiebrochure Persoonsgegevens {icon}
                </div>
              </Link>
            </li>
            <li>
